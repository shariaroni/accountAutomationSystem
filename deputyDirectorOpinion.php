...
<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = "INSERT INTO deputydirectoropinion (budget_id, deputydirector_id, budgetYear, budgetCode, budgetSector, pageNo, type, image, date, comment) VALUES ('$budget_id', $deputydirector_id, '$budgetYear', '$budgetCode', '$budgetSector', '$pageNo', '$type', '$image', '$date', '$comment')";
