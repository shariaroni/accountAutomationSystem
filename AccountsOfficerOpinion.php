...
<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = "INSERT INTO accountsofficeropinion (budgetSeleaction,budgetYear,budgetType,budgetCode,budgetSector,pageNo,type,image,day,month,year,comment) VALUES ('$budgetSeleaction','$budgetYear','$budgetType','$budgetCode','$budgetSector','$pageNo','$type','$image','$day','$month','$year','$comment')";
