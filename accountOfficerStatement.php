...
<body>
    ...
    <div class="container text-center mt-5" style="max-width: 675px; margin: 0, auto">
        <h4><strong> কর্মকর্তা (হিসাব দপ্তর) মতামত</strong> </h4>
            ...
            <?php
                ...
                if ($result-> num_rows > 0) {
                    ...
                    echo "<tr>
                        ...
                        প্রস্তাবিত <b>$budgetType</b> এর জন্য <b>".$row['budgetYear']."</b> অর্থ বছরে <b>$budget_type</b>, বাজেট কোড নম্বর <b>".$row['budgetCode']."</b>, বাজেট খাত <b>".$row['budgetSector']."</b>, এ বরাদ্দ আছে (বাজেট রেজিস্টারে রেকর্ড করা হয়েছে, পৃষ্ঠা নং- <b>".$row['pageNo']."</b> 
                    )। <br>
