<?php
    ...
    if (isset($_POST['applyForNoMoney'])) {
        ...
        else
        {
            ...
            $query = "INSERT INTO demand (document_number, office_department_name, total, comment, fiscal_year, source_of_money, expenditure_budget_sector, expenditure_budget_code, procurement_number, planned_price, procurement_type, details_of_goods_and_work, recommending_officer_id, user_id, date, stage, status) VALUES ('$document_number', '$office_department_name', '$total', '$comment', '$fiscal_year', '$Source_of_money', '$expenditure_budget_sector', '$expenditure_budget_code', '$procurement_number', '$planned_price', '$procurement_type', '$details_of_goods_and_work', '$recommending_officer_id', '$user_id', '$date', $stage, '$status')";
    ...
    <form action="applyType.php" method="POST">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <select class="form-select mt-2 d-inline" name="source_of_money">
                        <option class="d-inline dropdown-menu" value="Source of money null">অর্থের উৎস বাছাই করুন</option>
            ...
            <tr>
                ...
                <td>
                    <select class="form-select mt-2 d-inline" name="expenditure budget sector">
                        <option class="d-inline dropdown-menu" value="Expenditure budget sector null">ব্যয়ের বাজেট খাত বাছাই করুন</option>
            ...
            <tr>
                ...
                <td>
                    <select class="form-select mt-2 d-inline" name="expenditure_budget_code">
                        <option class="d-inline dropdown-menu" value="Expenditure budget code null">ব্যয়ের বাজেট কোড বাছাই করুন</option>
        ...
        <div class="text-center mt-4 mb-5">
            <input type="submit" class="btn btn-primary" name="applyForNoMoney" value="নিশ্চিত করুন">
        </div>  
    </form>
</div>